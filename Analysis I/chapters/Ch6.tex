...
\begin{rqq}
    \[ \int_{[a,b]}:\begin{array}[t]{ccc}\mathcal{E}([a,b],\mathbb{R}) & \to &\mathbb{R} \\ f & \tp & \int_{[a,b]}f \end{array} \]
...
\begin{thm}
    ...
    $F:\begin{array}[t]{ccc} [a,b] & \to & \mathbb{R} \\ x & \tp & \displaystyle\int_a^x f(t)\mathrm{d}t \end{array}$
    为$f$的一个原函数.
\end{thm}
