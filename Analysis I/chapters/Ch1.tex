...
\begin{deff} 
    设$S,T$为两集合,称$S$与$T$等势,若存在双射$f:S \to T$.记为$\left\lvert S \right\rvert = \left\lvert T \right\rvert$.
\end{deff}

\begin{deff}
    设$S$为集合,称$S$为有限集,若$S$为空集或存在$n\in\mathbb{N}^*$,使得${1,2,\cdots,n}$与$S$等势.记为$\left\lvert S \right\rvert = n$.
\end{deff}
...
\begin{deff}
    设$S$为集合,记$2^S$或$\mathcal{P}(S)$为$S$的子集的全体,称为$S$的幂集.
\end{deff}
