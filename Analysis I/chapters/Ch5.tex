...
\begin{deff}
    ...
    称$f$在$a$处取到极大值,若存在$\delta>0$,当$0<\left\lvert x-a \right\rvert \leqslant \delta$时,有$f(x) \leqslant f(a)$.

    称$f$在$a$处取到极小值,若存在$\delta>0$,当$0<\left\lvert x-a \right\rvert \leqslant \delta$时,有$f(x) \geqslant f(a)$.
\end{deff}
...
\begin{deff}
    设$f:I\to\mathbb{R}$.称$f$是压缩的,若存在$k\in(0,1)$,使得$f$是$k$-Lipschitz的.
\end{deff}
...
\begin{deff}
    设$f:I\to\mathbb{R}$,称$f$在$I$上二阶可导,若$f$在$I$上可导且$f'$在$I$上可导.
...
\begin{deff}
    设$f:I\to\mathbb{R}$,称$f$在$I$上$n$阶可导,若$f$在$I$上$n-1$阶可导且$f^{(n-1)}$在$I$上可导.
...
\begin{deff}
    ...
    均有$f$是$\mathcal{C}^n$的.此时也称$f$是光滑的.
\end{deff}
