...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item $\forall x,y \in \mathbb{R},0 \leqslant x,y \Rightarrow 0 \leqslant xy$.
    \end{itemize}
...
\begin{deff}
    设$(x_n)$为$\mathbb{R}$中序列,$x \in \mathbb{R}$.称$(x_n)$\textbf{收敛}于$x$,若
    $$
...
\begin{deff}
    设$X$上的一个关系$\sim$为:$(a_n) \sim (b_n) \Leftrightarrow 
    \forall \varepsilon \in \mathbb{Q}_+^*,\exists N \in \mathbb{N},
    \text{当}n>N\text{时,有}\left\lvert a_n - b_n \right\rvert < \varepsilon$.
\end{deff}

\begin{prop}
    $\sim$是一个等价关系,从而有等价类的集合$X/\sim$.
\end{prop}
