...
自然数集$\mathbb{N}$是一个非空集合,配上一个全序关系,以及与该序关系相容的一个加法运算和一个乘法运算,即满足:$$\forall x, y ,z \in \mathbb{N}, (x \leqslant y \Rightarrow x + z \leqslant y + z \text{且} xz \leqslant yz)$$
...
\begin{thm}[Eucildean除法]
    设$a \in \mathbb{N}, b \in \mathbb{N}^*$,则存在唯一$q, r \in \mathbb{N}$使得$$a = bq + r, r < b$$
    \begin{itemize}
        \item $q$称为$a$对$b$的Euclidean除法商.
        \item $r$称为$a$对$b$的Euclidean除法余数.
    \end{itemize}
\end{thm}