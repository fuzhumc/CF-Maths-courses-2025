...
\begin{prop}
    ...
    \begin{enumerate}
        ...
        \item $\complement_E A = \varnothing$.
...
\begin{prop}
    ...
    \begin{enumerate}
        ...
        \item $\mathbb{I}_{\complement_E A} = 1 - \mathbb{I}_A$.
    \end{enumerate}
\end{prop}
...
\begin{itemize}
    ...
    \item 直到19世纪,人们才处理$\mathbb{N}$的构造问题.对全体整数的严格构造超出了本课程的范围,我们将遵循数学家Kronecker所说:``上帝赐予我们整数,人类完成其余.''然而,在本书中列出详尽的公认性质必不可少的,这使得我们能构建后续内容.
\end{itemize}

自然数集$\mathbb{N}$是一个非空集合,配上一个全序关系,以及与该序关系相容的一个加法运算和一个乘法运算,即:$$\forall x, y ,z \in \mathbb{N}, (x \leqslant y \Rightarrow x + z \leqslant y + z \land x \leqslant y \Rightarrow xz \leqslant yz)$$
