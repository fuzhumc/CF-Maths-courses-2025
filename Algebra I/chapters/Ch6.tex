...
\begin{prop}
    设$A, P \in \mathbb{C}[x] \setminus \mathbb{C}, \alpha_1, \alpha_2, \cdots, \alpha_n \in \mathbb{C},
    r_1, r_2, \cdots, r_n \in \mathbb{N}^*$,$\alpha_k \in \mathbb{C}$为$A$的$r_k$重根.
    则$A \mid P$当且仅当$\alpha_k$为$P$的根且重数不低于$r_k$.
\end{prop}

\begin{prop}
    设$A \in \mathbb{R}[x] \setminus \mathbb{R}$,则有分裂$A = \lambda \prod\limits_{i = 1}^m
...
\begin{rqq}
    ...
    其中$\lambda \in K^*, A_i \in K[x] \text{首一}, \alpha_i \in \mathbb{N}^*$.
\end{rqq}
...
考虑$\alpha = \inf\limits_{z \in \mathbb{C}} \lvert A(z) \rvert$,
它存在,因为$\{ \lvert A(z) \rvert \mid z \in \mathbb{C} \}$为$\mathbb{R}_+$的非空子集.
接下来证明这个下确界可以取得且为0.
...
由于$\alpha = \inf\limits_{z \in \mathbb{C}} \lvert A(z) \rvert$,
...
设$a_q = \rho e^{- i \theta}$,其中$\rho \in \mathbb{R}_+^*, \theta \in \mathbb{R}$.
...
因此,存在$z \in \mathbb{C}$使得$\lvert A(z) \rvert < 1 = \alpha$,矛盾! \qed