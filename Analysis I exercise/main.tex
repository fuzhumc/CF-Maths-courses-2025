...
\title{Analysis I Exercise \\ \small{Gang Analysis}}
...
\noindent 亲爱的26级，27级还有往后的学弟学妹们：

\vspace{\baselineskip}

你们中的许多人我都永远不会见面，我却知道你们一定会被钢题折磨，这感觉属实有点滑稽。我眼前时时浮现你们抓耳挠腮的样子，尤其是考分析期末之时。我现在倒是不用做了，但是你们才刚刚开始做。

之后我估计不会再看这些东西了。

然而，我在漫长、离奇而可爱的一整个学期中学习到一件事，就是好的数学题是没有答案的。

仍在学高中数学竞赛的时候，我就应该在无数束手无策的题目中明白了。但我无论如何决定尝试。可惜在这场和数学的搏斗中，我输了。

但就算我赢了，数学依旧会取得最终的胜利，因为难度永远会趋于正无穷，去到我无法到达的地方。

所以这里面是全部的钢题。有一些题面简单但很复杂，有一些甚至是错题。但是无论如何都是值得好好看看学学的。即使大一不会，那就大二看，还可以去问问AI。

前路时有艰难，一如既往，只因天地不仁，以万物为刍狗。很遗憾我无法在考试前帮助你们押题。我希望能够留下足够的建议，助你们复习。

但我触目所及最多的是喜悦。你们的未来充满喜悦。生而为人，活在当下，经历大千世界，这是无与伦比的奇迹。你们可曾静下来思考这一点？思考成为这具身体中的灵魂，活在这个无奇不有、精彩绝伦的世上，是件多么奇特而幸运的事情。我非常感激早已了解、深爱你们所有。

如果你们记得几件事情，那么所有的失利、批评、绩点都无法击垮你们。

我们生来要全心全意地去爱。

在重压面前，保持你们的善良和同情——但不要让压力胜出。

未来在己不在人。不要在不属于自己的道路上一意孤行。寻找真相，为自己而思考。

上钢课之后，我以为自己的生活已经终结，没有什么值得为之而活。我真是大错特错了。继续前行吧。值得为之而活的事情无穷无尽，快乐终会再次来临。

此外——这件事虽然有点怪——不要过于在乎未来。否则你将会错过精彩纷呈的现在。

快乐吧，未来的中法班学子。你们可以用自己的喜悦和希望来改变世界。

\vspace{2\baselineskip}

\noindent 25级-亢春泰 a.k.a Starflight
\restoregeometry
