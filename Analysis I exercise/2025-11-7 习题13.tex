...
\item
  ...
  \end{enumerate}
\item
  设\(f,g\)均为Riemann可积函数,求证:\(m(x)=\min\{f(x),g(x)\},M(x)=\max\{f(x),g(x)\}\)也Riemann可积.
\item
  设\(f:[a,b]\to\mathbb{R}\) Riemann可积,且存在\(m>0\)使得\(\left\lvert f(x) \right\rvert \geq m\).证明: \(\frac{1}{f}\) Riemann可积.
\item
